...
from app.rbac_orchestrator import collect_rbac_data
...
async def _main(args: argparse.Namespace) -> None:
    _print_header("PostureIQ — RBAC Report Determinism Validation")
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="PostureIQ — RBAC Report Determinism Validation",
    )
