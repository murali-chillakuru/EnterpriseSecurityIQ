  ...
  <main class="content" id="main-content">
    <section id="doc-control" class="section">
      ...
      <table class="doc-control-table">
        ...
        <tr><th>Assessment Name</th><td>{esc(fw_label)} Executive Summary</td></tr>
    ...
    <section id="overview" class="section">
      ...
      <p style="color:var(--text-secondary)">PostureIQ {esc(fw_label)} Assessment &mdash;
...
def generate_executive_summary_md(
    ...
    W(f"# PostureIQ — Executive Summary\n")
