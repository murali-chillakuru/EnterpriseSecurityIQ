<#
.SYNOPSIS
    One-command setup for ReadOnlyExplorerIQ (ReadOnlyExplorer) on Azure + Teams.
...
.PARAMETER BrandName
    Resource prefix and display brand. Default: ReadOnlyExplorerIQ
...
[CmdletBinding()]
param(
    [string]$BrandName              = "ReadOnlyExplorerIQ",
...
Write-Banner "Setup — $BrandName (ReadOnlyExplorer)"
