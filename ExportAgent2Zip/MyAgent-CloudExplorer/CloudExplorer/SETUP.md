# CloudExplorerIQ — CloudExplorer

Isolated, deployable copy of the **CloudExplorer** agent generated from the
...
```powershell
.\setup.ps1 -BrandName "CloudExplorerIQ" -Location "northeurope" -SubscriptionId "<your-sub-id>"
```
