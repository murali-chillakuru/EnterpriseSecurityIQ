...
<title>Security Risk Gap Analysis — PostureIQ</title>
...
<section id="doc-control" class="section">
  <h1 class="page-title" data-tip="PostureIQ automated security risk gap analysis. This report evaluates identity, network, defender, and configuration risks across your Azure tenant.">Security Risk Gap Analysis Report</h1>
  <table class="doc-control-table">
    ...
    <tr><th data-tip="The name of the compliance assessment that generated this report.">Assessment Name</th><td>Security Risk Gap Analysis</td></tr>
