<#
.SYNOPSIS
    One-command setup for CloudExplorerIQ (CloudExplorer) on Azure + Teams.
...
.PARAMETER BrandName
    Resource prefix and display brand. Default: CloudExplorerIQ
...
[CmdletBinding()]
param(
    [string]$BrandName              = "CloudExplorerIQ",
...
Write-Banner "Setup — $BrandName (CloudExplorer)"
