...
<title>Data Security Assessment — PostureIQ</title>
...
<nav class="top-nav" aria-label="Report sections">
  <span class="brand" aria-hidden="true">&#128274; PostureIQ Data Security</span>
...
<section id="doc-control" class="section">
  <h1 class="page-title">Data Security Assessment Report</h1>
  <table class="doc-control-table">
    ...
    <tr><th data-tip="The name of the compliance assessment that generated this report.">Assessment Name</th><td>Data Security Assessment</td></tr>
    ...
    <tr><th data-tip="The PostureIQ tool version and agent that produced this report.">Tool</th><td>PostureIQ AI Agent v{VERSION}</td></tr>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>Data Security Executive Brief — PostureIQ</title>
<style>
...
<h1>&#128274; PostureIQ — Data Security Executive Brief</h1>
<div class="meta-bar">
...
<div class="footer">
  <strong>CONFIDENTIAL</strong> — Generated by PostureIQ v{VERSION}<br>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
<title>Cost of Non-Compliance Methodology — PostureIQ</title>
<style>
:root {{
...
<p style="font-size:14px;color:var(--text-secondary);margin:12px 0;line-height:1.8">
  This report details how PostureIQ estimates the financial exposure arising from unresolved
...
<footer>
  Generated by PostureIQ {VERSION} &nbsp;|&nbsp;
