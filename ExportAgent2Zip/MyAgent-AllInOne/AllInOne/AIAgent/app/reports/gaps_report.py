...
<title>PostureIQ &mdash; Gaps Analysis Report</title>
<style>{get_css()}</style>
</head>
<body>
  ...
  <main class="content" id="main-content">
    ...
    <section id="doc-control" class="section">
      ...
      <table class="doc-control-table">
        ...
        <tr><th>Assessment Name</th><td>{esc(fw_label)} Gaps Analysis</td></tr>
        ...
        <tr><th>Tool</th><td>PostureIQ AI Agent v1.0</td></tr>
      </table>
    ...
    <section id="overview" class="section">
      <h1 class="page-title">Gaps Analysis Report</h1>
    ...
    <footer style="text-align:center;color:var(--text-muted);font-size:12px;padding:32px 0;border-top:1px solid var(--border)">
      Generated by PostureIQ AI Agent v1.0 &mdash; {format_date_short(ts)} &mdash; CONFIDENTIAL
    </footer>
  </main>
</div>
...
def generate_gaps_report_md(
    ...
    W(f"# PostureIQ — Gaps Analysis Report\n")
