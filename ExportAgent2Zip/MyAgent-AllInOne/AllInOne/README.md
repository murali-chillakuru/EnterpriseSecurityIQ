# EnterpriseSecurityIQ — AllInOne

Isolated, deployable copy of the **AllInOne** agent generated from the
...
```powershell
.\setup.ps1 -BrandName "EnterpriseSecurityIQ" -Location "northeurope" -SubscriptionId "<your-sub-id>"
```
...
- `PostureIQHomePage.html`
- `PostureIQ.html`
- `SecurityComplianceAssessment.html`
- `Teams-SecurityComplianceAssessment.html`
- `Teams2Web-SecurityComplianceAssessment.html`
- `DataSecurity.html`
