<#
.SYNOPSIS
    One-command setup for EnterpriseSecurityIQ (AllInOne) on Azure + Teams.
...
.PARAMETER BrandName
    Resource prefix and display brand. Default: EnterpriseSecurityIQ
...
[CmdletBinding()]
param(
    [string]$BrandName              = "EnterpriseSecurityIQ",
...
Write-Banner "Setup — $BrandName (AllInOne)"
