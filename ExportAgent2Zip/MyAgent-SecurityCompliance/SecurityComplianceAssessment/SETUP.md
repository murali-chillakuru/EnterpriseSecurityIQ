# PostureIQ — SecurityComplianceAssessment

Isolated, deployable copy of the **SecurityComplianceAssessment** agent generated from the
...
```powershell
.\setup.ps1 -BrandName "PostureIQ" -Location "northeurope" -SubscriptionId "<your-sub-id>"
```
