<#
.SYNOPSIS
    One-command setup for PostureIQ (SecurityComplianceAssessment) on Azure + Teams.
...
.PARAMETER BrandName
    Resource prefix and display brand. Default: PostureIQ
...
Write-Banner "Setup — $BrandName (SecurityComplianceAssessment)"
