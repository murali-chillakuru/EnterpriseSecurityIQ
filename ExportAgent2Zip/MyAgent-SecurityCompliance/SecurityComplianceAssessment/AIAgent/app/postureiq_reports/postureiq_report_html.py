...
@media print{.top-nav,.filter-bar,.zoom-controls,.back-to-top,.skip-nav{display:none!important}.full-width-content{padding:16px;max-width:100%}body{background:#fff;color:#000;font-size:12px}h2,h3,h4{page-break-after:avoid;break-after:avoid}.exec-panel,.exec-grid,.table-guide,.access-info{page-break-inside:avoid;break-inside:avoid}details.sub-section{page-break-inside:avoid;break-inside:avoid}table{page-break-inside:auto}tr{page-break-inside:avoid;break-inside:avoid}thead{display:table-header-group}section{page-break-before:auto;page-break-inside:auto}.stat-card{page-break-inside:avoid;break-inside:avoid}.severity-bars,.sev-bar-row{page-break-inside:avoid;break-inside:avoid}}
"""
...
<main id="main" class="full-width-content">
    ...
    <section id="doc-control" class="section">
      <h1 class="page-title">{esc(fw_label)} Compliance Assessment Report</h1>
