...
class CollectorConfig:
    ...
    subscription_filter: list[str] = field(default_factory=list)
    azure_batch_size: int = 12      # Max concurrent Azure collectors
    entra_batch_size: int = 9       # Max concurrent Entra collectors
    ...
    ai_fixes_max: int = 5          # Max findings for AI fix generation (0=disable)
...
class AssessmentConfig:
    ...
    def from_file(cls, path: str) -> AssessmentConfig:
        ...
        if coll:
            ...
            cfg.collectors.ai_fixes_max = coll.get("aiFixesMax", cfg.collectors.ai_fixes_max)
        # Thresholds section
