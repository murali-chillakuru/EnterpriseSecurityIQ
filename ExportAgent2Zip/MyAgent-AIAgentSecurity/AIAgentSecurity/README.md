# AIAgentSecurityIQ — AIAgentSecurity

Isolated, deployable copy of the **AIAgentSecurity** agent generated from the
...
```powershell
.\setup.ps1 -BrandName "AIAgentSecurityIQ" -Location "northeurope" -SubscriptionId "<your-sub-id>"
```
