<#
.SYNOPSIS
    One-command setup for AIAgentSecurityIQ (AIAgentSecurity) on Azure + Teams.
...
.PARAMETER BrandName
    Resource prefix and display brand. Default: AIAgentSecurityIQ
...
[CmdletBinding()]
param(
    [string]$BrandName              = "AIAgentSecurityIQ",
...
Write-Banner "Setup — $BrandName (AIAgentSecurity)"
