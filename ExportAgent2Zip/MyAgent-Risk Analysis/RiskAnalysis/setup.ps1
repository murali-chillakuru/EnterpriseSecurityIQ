<#
.SYNOPSIS
    One-command setup for RiskAnalysisIQ (RiskAnalysis) on Azure + Teams.
...
.PARAMETER BrandName
    Resource prefix and display brand. Default: RiskAnalysisIQ
...
[CmdletBinding()]
param(
    [string]$BrandName              = "RiskAnalysisIQ",
...
Write-Banner "Setup — $BrandName (RiskAnalysis)"
