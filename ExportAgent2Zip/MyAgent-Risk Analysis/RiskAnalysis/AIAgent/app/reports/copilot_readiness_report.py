...
<title>M365 Copilot Readiness — PostureIQ</title>
...
<nav class="top-nav" aria-label="Report sections">
  <span class="brand">&#129302; PostureIQ</span>
...
<section id="doc-control" class="section">
  <h1 class="page-title">M365 Copilot Readiness Assessment Report</h1>
  <table class="doc-control-table">
    <tr><th>Report Identifier</th><td>{esc(report_id)}</td></tr>
    <tr><th>Assessment Name</th><td>M365 Copilot Readiness Assessment</td></tr>
