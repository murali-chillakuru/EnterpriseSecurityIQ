# RiskAnalysisIQ — RiskAnalysis

Isolated, deployable copy of the **RiskAnalysis** agent generated from the
...
```powershell
.\setup.ps1 -BrandName "RiskAnalysisIQ" -Location "northeurope" -SubscriptionId "<your-sub-id>"
```
