# PostureIQ — Web Dashboard

**Author:** Murali Chillakuru

A single-page web application for interacting with the PostureIQ agent through a browser. Provides a visual interface for running assessments, viewing results, and querying the agent.
...
- A deployed PostureIQ agent (see [Deployment Guide](../docs/deployment.md))
