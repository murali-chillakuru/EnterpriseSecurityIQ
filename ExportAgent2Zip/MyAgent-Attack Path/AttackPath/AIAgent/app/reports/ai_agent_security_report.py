...
<title>AI Agent Security — PostureIQ</title>
...
<section id="doc-control" class="section">
  <h1 class="page-title">AI Agent Security Assessment Report</h1>
...
• AI Agent Security module of PostureIQ
• Evaluates Copilot Studio, Microsoft Foundry, Azure AI, and custom agents
• Covers {len(_CATEGORY_META)} security domains">Assessment Name</th><td>AI Agent Security Assessment</td></tr>
...
• PostureIQ AI Agent v{VERSION}
• Version tracking ensures reproducibility
• Re-running with the same version guarantees consistent rules and scoring">Tool</th><td>PostureIQ AI Agent v{VERSION}</td></tr>
