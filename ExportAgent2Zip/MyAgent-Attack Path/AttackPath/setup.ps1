<#
.SYNOPSIS
    One-command setup for AttackPathIQ (AttackPath) on Azure + Teams.
...
.PARAMETER BrandName
    Resource prefix and display brand. Default: AttackPathIQ
...
Write-Banner "Setup — $BrandName (AttackPath)"
