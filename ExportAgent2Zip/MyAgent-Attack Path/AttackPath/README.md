# AttackPathIQ — AttackPath

Isolated, deployable copy of the **AttackPath** agent generated from the
...
```powershell
.\setup.ps1 -BrandName "AttackPathIQ" -Location "northeurope" -SubscriptionId "<your-sub-id>"
```
