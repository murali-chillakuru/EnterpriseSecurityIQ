# DataSecurityIQ — DataSecurity

Isolated, deployable copy of the **DataSecurity** agent generated from the
...
```powershell
.\setup.ps1 -BrandName "DataSecurityIQ" -Location "northeurope" -SubscriptionId "<your-sub-id>"
```
