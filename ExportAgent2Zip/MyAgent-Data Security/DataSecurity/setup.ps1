<#
.SYNOPSIS
    One-command setup for DataSecurityIQ (DataSecurity) on Azure + Teams.
...
.PARAMETER BrandName
    Resource prefix and display brand. Default: DataSecurityIQ
...
[CmdletBinding()]
param(
    [string]$BrandName              = "DataSecurityIQ",
...
Write-Banner "Setup — $BrandName (DataSecurity)"
