...
<title>Azure RBAC Hierarchy &amp; Access Analysis — PostureIQ</title>
...
<section id="doc-control" class="section">
  <h1 class="page-title">Azure RBAC Assessment Report</h1>
  <table class="doc-control-table">
    <tr><th>Report Identifier</th><td>{esc(report_id)}</td></tr>
    <tr><th>Assessment Name</th><td>Azure RBAC Hierarchy &amp; Access Analysis</td></tr>
