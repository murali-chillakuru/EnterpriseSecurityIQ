# CopilotReadinessIQ — CopilotReadiness

Isolated, deployable copy of the **CopilotReadiness** agent generated from the
...
```powershell
.\setup.ps1 -BrandName "CopilotReadinessIQ" -Location "northeurope" -SubscriptionId "<your-sub-id>"
```
