<#
.SYNOPSIS
    One-command setup for RBACReportIQ (RBACReport) on Azure + Teams.
...
.PARAMETER BrandName
    Resource prefix and display brand. Default: RBACReportIQ
...
Write-Banner "Setup — $BrandName (RBACReport)"
