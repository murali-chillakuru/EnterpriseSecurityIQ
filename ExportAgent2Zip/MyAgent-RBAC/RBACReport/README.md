# RBACReportIQ — RBACReport

Isolated, deployable copy of the **RBACReport** agent generated from the
...
```powershell
.\setup.ps1 -BrandName "RBACReportIQ" -Location "northeurope" -SubscriptionId "<your-sub-id>"
```
